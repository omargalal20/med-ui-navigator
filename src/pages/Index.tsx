    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
          <Card className="group hover:shadow-lg transition-all duration-300 border-slate-200 bg-white/80 backdrop-blur-sm flex flex-col h-full">
            <CardHeader className="pb-4 flex-grow">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mb-4">
                <MessageSquare className="h-6 w-6 text-white" />
              </div>
              <CardTitle className="text-xl md:text-2xl font-medium text-slate-900">General Medical Q&A</CardTitle>
              <CardDescription className="text-slate-600 text-sm md:text-base leading-relaxed flex-grow">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-slate-200 bg-white/80 backdrop-blur-sm flex flex-col h-full">
            <CardHeader className="pb-4 flex-grow">
              ...
              <CardTitle className="text-xl md:text-2xl font-medium text-slate-900">Patient Management</CardTitle>
              <CardDescription className="text-slate-600 text-sm md:text-base leading-relaxed flex-grow">
        ...
        {/* Trust Indicators */}
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-slate-200 p-6 md:p-8">
          <h3 className="text-xl md:text-2xl font-medium text-slate-900 text-center mb-6 md:mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-600 text-sm">Secure, encrypted platform ensuring patient privacy and data protection.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-600 text-sm">AI trained on current medical literature and clinical guidelines.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-600 text-sm">Round-the-clock medical assistance for urgent clinical decisions.</p>
            </div>
          </div>
        </div>
      </section>
